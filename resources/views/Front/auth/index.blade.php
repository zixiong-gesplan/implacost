    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50 p-8">
        <main class="w-full h-full">
            <form action="{{ url('/login') }}" method="post" class="max-w-sm mx-auto">
                ...
                <button type="submit" class="text-white bg-sky-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-sky-900 dark:focus:ring-blue-800">
                    Entrar
                </button>
            </form>
        </main>
